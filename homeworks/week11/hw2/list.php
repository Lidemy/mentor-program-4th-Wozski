...
$sql = "select * from comments order by create_at DESC";
    ...
    <div class="container">
      <div class="admin-posts">
        ...
        <div class="admin-post">
          ...
          <?php if (!empty($username)) {?>
          <a class="admin-post__btn" href="update.php?id=<?php echo $row['id']?>">
            編輯
          </a>
          ...
          <?php }?>  
          <a class="admin-post__btn" href="blog.php?id=<?php echo $row['id']?>">
            瀏覽
          </a>
          </div>
        </div>
